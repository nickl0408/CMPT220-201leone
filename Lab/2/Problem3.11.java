...
public class Month {
	...
	public static void main(String[] args) {
		...
		//Prompts the user to type in the year and month
		System.out.print("Enter the month in the form of an integer: ");;
		int month = input.nextInt();
		System.out.print("Enter the year in the form of an integer: ");
		...
		//Will show the number of days in the current month
		switch (month)
